...
namespace projekt_restoran.Controllers
{
    ...
    public class MenuItemsController : ControllerBase
    {
        ...
        // GET: api/MenuItems
        [HttpGet]
        public async Task<ActionResult<IEnumerable<DTOs.MenuItemDTO>>> GetMenuItems()
        {
        ...
        // GET: api/MenuItems/5
        [HttpGet("{id}")]
        public async Task<ActionResult<DTOs.MenuItemDetailDTO>> GetMenuItem(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutMenuItem(int id, DTOs.MenuItemDetailDTO menuItemDto)
        {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<MenuItem>> PostMenuItem(DTOs.MenuItemCreateDTO menuItemDTO)
        {
